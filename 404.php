						...
						<div class="page-content">
							...
							<?php if ( skycraft_categorized_blog() ) : // Only show the widget if site has multiple categories. ?>
								...
								<div class="widget widget_categories">
									...
									<h2 class="widget-title"><?php esc_html_e( 'Most Used Categories', 'skycraft' ); ?></h2>
							...
							$archive_content = '<p>' . sprintf( esc_html__( 'Try looking in the monthly archives. %1$s', 'skycraft' ), convert_smilies( ':)' ) ) . '</p>';
